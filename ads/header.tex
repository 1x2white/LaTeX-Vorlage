...
\usepackage[printonlyused, nohyperlinks]{acronym} % falls gewünscht kann die Option footnote eingefügt werden, dann wird die Erklärung nicht inline sondern in einer Fußnote dargestellt
\usepackage{listings}
\usepackage{tikz}
\usepackage{tikz-uml}
\usepackage{tabularx,ragged2e}
\usepackage{lastpage} % für die automatische anzeige der letzten Seitenzahl

% für die fortlaufende Nummerierung der Abbildungen etc.
\usepackage{chngcntr}				
...
\usepackage[%
	...
	hyperfootnotes=false			% Keine Verlinkungen von Intext-Referenzen
]{hyperref}
